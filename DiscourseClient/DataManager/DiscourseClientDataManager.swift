...
extension DiscourseClientDataManager: TopicsDataManager {
    ...
    func fetchLastPosterDetails(username: String, completion: @escaping (Result<UserDetailResponse, Error>) -> ()) {
...
extension DiscourseClientDataManager : UserDetailDataManager {
    ...
    func fetchDetailById(id: Int, completion: @escaping (Result<UserDetailByIdResponse, Error>) -> ()) {
        remoteDataManager.fetchUserById(id: id, completion: completion)
    }
